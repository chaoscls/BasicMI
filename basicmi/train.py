...
from basicmi.data.prefetch_dataloader import CPUPrefetcher, CUDAPrefetcher
from basicmi.models import build_model
from basicmi.utils import (AvgTimer, MessageLogger, check_resume, get_env_info, get_root_logger, get_time_str,
                           init_tb_logger,  make_exp_dirs, mkdir_and_rename, scandir)
from basicmi.utils.options import copy_opt_file, dict2str, parse_options
    ...
    for phase, dataset_opt in opt['datasets'].items():
        if phase == 'train':
            ...
            logger.info('Training statistics:'
                        ...
                        f'\n\tDataset enlarge ratio: {enlarge_ratio}'
...
def train_pipeline(root_path):
    ...
    logger = get_root_logger(logger_name='basicmi', log_level=logging.INFO, log_file=log_file)
    ...
    # training
    logger.info(f'Stat training from epoch: {start_epoch}, iter: {current_iter}')
